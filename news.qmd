...
**Introductory Workshop on Machine Learning at the Early Career Researcher Retreat of the Methods and Evaluation Section of the German Psychological Society (DGPs)**

The Methods and Evaluation Section of the German Psychological Society (DGPs) is organizing an ECR retreat for methodologists from October 7–9, 2026, in Frankfurt. As part of the retreat program, David will teach a workshop titled *Introduction to Supervised Machine Learning*.

\

**Bi-annual Congress of the German Psychological Society (DGPs) in Luxembourg**

On September 7, we (Melanie, Luz, Tizian, Philipp, Mareike, and David) will present our research at the DGPs Congress 2026 in Luxembourg. Philipp will chair the symposium titled "New Insights from Measurement and Machine Learning for Applied Psychology" that provides an overview of our different research topics including model fit evaluation, measurement invariance testing, and factor retention.

\

**GESIS Summer School in Survey Methodology: Week-long Workshop on Latent Variable Modeling**

From August 3 to August 7 2026, Melanie and David will teach a workshop on latent variable modeling in the context of survey research at the *GESIS Summer School in Survey Methodology* in Cologne. More information can be found on the [website](https://www.gesis.org/en/gesis-training/what-we-offer/summer-school-in-survey-methodology) of GESIS.

\

**International Meeting of the Psychometric Society (IMPS) 2026 in Seoul**

From July 21-24, the IMPS takes place in Seoul, South Korea. We (Melanie, Mareike, and David; together with researchers from LMU Munich and the University of Basel) will present our research in a symposium called "Bridging psychometrics and modern data science: Applications in machine learning and causal inference" that will be chaired by Melanie.

\

**Introductory Workshop on Machine Learning at the University of Padova**

On Friday, July 10 2026, David will give an *Introduction to Supervised Machine Learning* at the University of Padova as part of the ARCA Summer School. More information can be found on the [website](https://www.unipd.it/en/arca-summer-schools) of the University of Padova.
...
David has been invited to give a keynote speech and a workshop on machine learning in psychological assessment at the *International Conference on Cognitive and Psychological Assessment and Enhancement (ICCPAE 2025)* in Beijing (11/07/2025 - 13/07/2025).
...
Our paper on the use of EFA and CFA trees for measurement invariance exploration in organizational research was accepted for publication in the *Journal of Applied Psychology*:

Goretzko, D., Howard, M. C., & Sterner, P. (2025). Investigating Measurement Invariance for Multiple Covariates in Organizational Research using EFA and CFA Trees. *Journal of Applied Psychology*. <https://doi.org/10.1037/apl0001368>

\

We are delighted that our paper *Detecting model misfit in structural equation modeling with machine learning—A proof of concept* was accepted for publication in *Multivariate Behavioral Research*:
...
Goretzko, D., & Sterner, P. (2025). Exploratory Graph Analysis Trees – A Network-based Approach to Investigate Measurement Invariance with Numerous Covariates. *Psychological Methods*. Preprint: <https://doi.org/10.31234/osf.io/9cx8z>.
