...
Partsch, M. V., Sterner, P., & Goretzko, D. (accepted for publication). A simulation study on the interaction effects of underfactoring and nuisance parameters on model fit indices. Structural Equation Modeling: A Multidisciplinary Journal. <https://osf.io/preprints/psyarxiv/qy2e3_v1>
...
Goretzko, D., & Sterner, P. (accepted for publication). Exploratory Graph Analysis Trees-A Network-based Approach to Investigate Measurement Invariance with Numerous Covariates. Psychological Methods. <https://osf.io/9cx8z>
